      ...
      <section className="py-16 lg:py-24 bg-mist">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="font-heading font-bold text-3xl lg:text-4xl text-navy mb-4" data-testid="heading-choose-package">
              Choose Your Package
            </h2>
            <p className="text-slate text-lg max-w-2xl mx-auto">
              Select the package that best fits your travel and conference needs
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {packages && packages.length > 0 ? (
              ...
              <p className="text-center text-slate text-lg">No packages available at the moment.</p>
            )}
          </div>
        </div>
      </section>
